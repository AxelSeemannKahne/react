 ...
 * Test case
 */
class FoodPresetTest extends UnitTestCase
{
    /**
     * @var \ASK\AskCaloriecounter\Domain\Model\FoodPreset|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \ASK\AskCaloriecounter\Domain\Model\FoodPreset::class,
            ['dummy']
        );
    }
     ...
     * @test
     */
    public function getSugarReturnsInitialValueForString(): void
    {
        self::assertSame(
            '',
     ...
     * @test
     */
    public function setSugarForStringSetsSugar(): void
    {
        $this->subject->setSugar('Conceived at T3CON10');

        self::assertEquals('Conceived at T3CON10', $this->subject->_get('sugar'));
    }
