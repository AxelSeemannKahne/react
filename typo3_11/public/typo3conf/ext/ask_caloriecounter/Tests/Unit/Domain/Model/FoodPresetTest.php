...
class FoodPresetTest extends UnitTestCase
{
     ...
     * @test
     */
    public function getProteinReturnsInitialValueForInt(): void
    {
        self::assertSame(
            0,
     ...
     * @test
     */
    public function setProteinForIntSetsProtein(): void
    {
        $this->subject->setProtein(12);

        self::assertEquals(12, $this->subject->_get('protein'));
    }
